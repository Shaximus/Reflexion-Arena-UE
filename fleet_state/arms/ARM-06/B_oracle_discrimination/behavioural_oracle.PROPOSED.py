...
behavioural quantity stays identical to canonical. This oracle passes those runs, correctly
— there is no behavioural difference in end state for it to report. The hash flags them.
That division of labour is the design, not a gap.
